...
<div class="container">
    ...
    <section class="popular-cards-config">
        ...
        <div class="slider-arrow next-btn">
            <img src="./assets/images/Button - Next.svg" />
        </div>
    ...
    <section class="need-to-help">
        <h2 class="hedline-h2">Нужна помощь?</h2>
        <p class="sub-head">Получите бесплатную консультацию от нашего специалиста</p>
        <div class="help-cont-info">
            <div class="robot-cont">
                ...
                <div class="robot-info">
                    <div class="name-cont">
                        <p class="name-robot">Фёдор</p>
                        <p class="profession-robot">Робот - консультант</p>
                    </div>
            ...
            <div class="bullets-cont">
                <div class="bullet">
                    ...
                    <span>Подбор 3-х вариантов сборки</span>
                </div>
                <div class="bullet">
                    <img src="./assets/images/Like.svg" alt="">
                    <span>Оценка сборки</span>
                </div>
                <div class="bullet">
                    <img src="./assets/images/Hand Stars.svg" alt="">
                    <span>Рекомендации под ваши задачи</span>
                </div>
                <div class="bullet">
                    <img src="./assets/images/Messages.svg" alt="">
                    <span>Консультации по другим вопросам</span>
                </div>
            </div>
            <div class="contacts-us-cont">
                <h3 class="title-contacts">Связаться с нами</h3>
                ...
                <button class="primary-btn">Задать вопрос</button>
            </div>
        </div>
    </section>
    <section class="review">
        ...
        <div class="review-list">
            <div class="review-item">
                ...
                <div class="rating-review">
                    <img src="./assets/images/star-bg.svg" alt="">
                    <img src="./assets/images/star-bg.svg" alt="">
                    <img src="./assets/images/star-bg.svg" alt="">
                    <img src="./assets/images/star-bg.svg" alt="">
                    <img src="./assets/images/star-bg.svg" alt="">
            ...
            <div class="review-item">
                ...
                <div class="rating-review">
                    ...
                    <img src="./assets/images/star-bg.svg" alt="">
                    <img src="./assets/images/star-bg.svg" alt="">
                    <img src="./assets/images/star-no-bg.svg" alt="">
                </div>
        ...
        <button class="primary-btn">Добавить отзыв
            <img src="./assets/images/plus-review.svg" alt="">
        </button>
    </section>
    <section class="faq">
                ...
                <div class="faq-item">
                    <div class="name-item-faq">
                        ...
                        <div class="btn-arr-faq">
                            <img class="arrow-up" src="./assets/images/arrow-up.svg" alt="">
        ...
        <button class="primary-btn">Задать вопрос
            <img src="./assets/images/plus-review.svg" alt="">
        </button>
    </section>
    <section class="our-brands">
        ...
        <div class="brand-cont">
            <div class="item-brand">
                <img src="./assets/images/intel-6 1.svg" alt="">
            </div>
            <div class="item-brand">
                <img src="./assets/images/ryzen 1.svg" alt="">
            </div>
            <div class="item-brand">
                <img src="./assets/images/logitech-2-1 1.svg" alt="">
            </div>
            <div class="item-brand">
                <img src="./assets/images/asus-logo 1.svg" alt="">
            </div>
            <div class="item-brand">
                <img src="./assets/images/kingston-technology 1.svg" alt="">
            </div>
        </div>
    </section>
</div>
